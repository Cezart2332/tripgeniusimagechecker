...
# unitary/multilingual-toxic-xlm-roberta: single toxic score; ~0.5 is a typical cutoff.
TOXIC_THRESHOLD = float(os.getenv("TOXIC_THRESHOLD", "0.5"))
SHORT_TEXT_LEN = int(os.getenv("SHORT_TEXT_LEN", "16"))
SHORT_TEXT_TOXIC_THRESHOLD = float(os.getenv("SHORT_TEXT_TOXIC_THRESHOLD", "0.55"))
...
# Labels that can trigger a block. Default matches unitary (toxic only).
# For oleksiizirka multi-label builds, set TOXIC_LABELS via env.
_DEFAULT_TOXIC_LABELS = ("toxic",)
